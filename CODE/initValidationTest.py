...
import initOpinion
import initWeight
import runModelsValidationTest
import readGraph
import initPower
import random
import signal
...
for iter_ in range(0, total_iterations):
	p = multiprocessing.Process(target = runModelsValidationTest.voterObject, args=(G_list[iter_], iter_, network_name, aggressive_bound, aggressiveness_initialization_type, boundDown, boundUp, selectedEdges[iter_], "random", dBounds_down, dBounds_up, dBounds_step, 'seed_'+str(SEED[0])))
...
for iter_ in range(0, total_iterations):
	p = multiprocessing.Process(target = runModelsValidationTest.voterObject, args=(G_list[iter_], iter_, network_name, aggressive_bound, aggressiveness_initialization_type, boundDown, boundUp, selectedEdges[iter_], "sorted", dBounds_down, dBounds_up, dBounds_step, 'seed_'+str(SEED[0])))
...
for iter_ in range(0, total_iterations):
	p = multiprocessing.Process(target = runModelsValidationTest.voterObject, args=(G_list[iter_], iter_, network_name, aggressive_bound, aggressiveness_initialization_type, boundDown, boundUp, selectedEdges[iter_], "neighborhood", dBounds_down, dBounds_up, dBounds_step, 'seed_'+str(SEED[0])))
...
iter_processes_neighborhood = []
for iter_ in range(0, total_iterations):
	p = multiprocessing.Process(target = runModelsValidationTest.voterObject, args=(G_list[iter_], iter_, network_name, aggressive_bound, aggressiveness_initialization_type, boundDown, boundUp, selectedEdges[iter_], "popularity_increase", dBounds_down, dBounds_up, dBounds_step, 'seed_'+str(SEED[0])))
	iter_processes_neighborhood.append(p)
	p.start()
...
iter_processes_neighborhood = []
for iter_ in range(0, total_iterations):
	p = multiprocessing.Process(target = runModelsValidationTest.voterObject, args=(G_list[iter_], iter_, network_name, aggressive_bound, aggressiveness_initialization_type, boundDown, boundUp, selectedEdges[iter_], "popularity_descending", dBounds_down, dBounds_up, dBounds_step, 'seed_'+str(SEED[0])))
	iter_processes_neighborhood.append(p)
	p.start()
